...
var shapes = []
var material = new THREE.MeshPhongMaterial({color: 0xe0561f});
...
shapes.push(new THREE.Mesh(new THREE.SphereGeometry(mesh_radius, 30, 30), material));
